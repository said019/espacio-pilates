                ...
                {isWalkIn && (
                  <div className="rounded-xl border border-[#E5CF9F] bg-[#F4EAD6]/60 px-3 py-2 text-xs text-[#8A672C]">
                    {walkInRequiresInscription
                      ...
                      : "Esta clase es walk-in gratis: no descuenta créditos ni requiere inscripción. Solo una clase gratis por usuaria entre ambas sucursales; cancelar no reinicia el beneficio."}
                  </div>
                )}
                <div className="flex items-center gap-2 text-sm">
